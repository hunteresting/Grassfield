def get_parent_index(complete_binary_tree, index):
    ...
    if parent_index not in range(1, len(complete_binary_tree)):
        return None
...
def get_left_child_index(complete_binary_tree, index):
    ...
    left_child = index * 2
    if left_child not in range(1, len(complete_binary_tree)):
        return None
...
def get_right_child_index(complete_binary_tree, index):
    ...
    if right_child not in range(1, len(complete_binary_tree)):
        return None
